...
namespace DustInTheWind.CaveOfWonders.Tests.Integration.Ports.DataAccess.Gateways;
...
/// same temporary resource as the SUT fixture, but through its own, independently opened session.
/// </summary>
