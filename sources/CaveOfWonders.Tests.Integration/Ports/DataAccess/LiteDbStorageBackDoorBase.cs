...
/// <summary>
/// Base class for the LiteDb storage back doors. Owns the back-door session: a <see cref="DbContext"/>
...
/// </summary>
internal abstract class LiteDbStorageBackDoorBase
{
	private readonly LiteDbTempDatabase liteDbTempDatabase;

	protected DbContext DbContext { get; private set; }

	protected LiteDbStorageBackDoorBase(LiteDbTempDatabase liteDbTempDatabase)
	{
