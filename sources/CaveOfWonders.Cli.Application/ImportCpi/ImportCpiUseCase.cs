...
internal class ImportCpiUseCase : IUseCase<ImportCpiRequest, ImportCpiResponse>
{
	...
	public async Task<ImportCpiResponse> Execute(ImportCpiRequest request, CancellationToken cancellationToken)
	{
