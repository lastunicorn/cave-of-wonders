...
namespace DustInTheWind.CaveOfWonders.Cli.Application.ImportFromNbrWebsite;

public class ImportFromNbrWebsiteResponse
{
    ...
    internal ImportFromNbrWebsiteResponse(ImportReport report)
    {
