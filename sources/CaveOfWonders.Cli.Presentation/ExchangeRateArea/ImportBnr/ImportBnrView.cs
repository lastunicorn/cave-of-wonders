...
namespace DustInTheWind.CaveOfWonders.Cli.Presentation.ExchangeRateArea.ImportBnr;

internal class ImportBnrView : IView<ImportFromBnrResponse>
{
    public void Display(ImportFromBnrResponse response)
    {
