...
internal class InsWebPageErrorHandler : JsonErrorHandler<InsWebPageException, string>
{
    protected override HttpStatusCode HttpStatusCode => HttpStatusCode.BadRequest;

    protected override string BuildHttpResponseBody(InsWebPageException ex)
    {
        return $"Failed to access INS web page: {ex.Message}";
    }
}
