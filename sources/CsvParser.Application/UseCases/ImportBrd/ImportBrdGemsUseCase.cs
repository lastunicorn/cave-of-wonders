...
public class ImportBrdGemsUseCase
{
    ...
    public async Task<ImportBrdResponse> Execute()
    {
        ...
        IEnumerable<SheetValue> sheetsValues = sheets.GetBrdRecords(SourceFilePath);
